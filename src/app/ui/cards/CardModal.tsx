...
export const CardModal = ({
  ...
  return (
    ...
    >
      ...
      <section
        className="flex flex-col fixed max-h-[90%] overflow-scroll top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-background-color rounded-lg px-3 py-6 w-fit"
        onClick={(e) => {
          e.stopPropagation()
        }}
      >
